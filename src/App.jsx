    ...
    <div className="h-screen bg-surface text-body flex flex-col overflow-hidden">
      ...
      <header className="flex items-center justify-between border-b border-muted shrink-0 px-4 py-2">
        <div className="flex flex-row items-center gap-3">
          <img src="/faultlens.svg" alt="FaultLens" className="h-6" />
          <h1 className="text-[14px] md:text-4xl leading-none tracking-wide text-body font-display">
            Fault<span className="text-acid">Lens</span>
          </h1>
        </div>
        <button
          onClick={() => setShowSaved(true)}
          className="px-2 py-1.5 border border-acid text-[14px] text-acid font-mono cursor-pointer"
        >
          SAVED REQUESTS
        </button>
      </header>

      <div className="flex-1 relative overflow-hidden flex justify-center items-start mt-6">
        <div
      ...
      <div className="h-64 md:h-65 border-t border-border flex shrink-0">
      ...
      <div className="h-[35%] max-h-65 flex-1 relative overflow-hidden">
        <div
